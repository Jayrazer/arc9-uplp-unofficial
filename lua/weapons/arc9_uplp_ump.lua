...
SWEP.PrintName = "VMP-45"
SWEP.Description = "The \"Versuchsmaschinenpistole Kaliber .45\" (Experimental Machine Pistol, Caliber .45) is a modern submachine gun intended to replace the aging PV-9, though both remain in production and common use."
...
SWEP.Trivia = {
    [ ARC9:GetPhrase( "uplp_realname" ) ] = "UMP-45",
...
SWEP.WorldModelOffset = {
    Pos = Vector(-3.5, 3, -8),
    Ang = Angle(0, 0, 180),
    TPIKPos = Vector(-9.5, 3, -5),
    TPIKAng = Angle(-12, -0, 180),
    Scale = 1,

    TPIKPosSightOffset = Vector(2, 2, -2.5),
}
