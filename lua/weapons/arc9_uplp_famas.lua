...
SWEP.PrintName = "Valeureux FR"
SWEP.Description = "A French assault rifle from the Cold War that has been given several upgrades to modernize it."
...
SWEP.Trivia = {
    [ ARC9:GetPhrase( "uplp_realname" ) ] = "FAMAS Valorise",

    [ ARC9:GetPhrase( "uplp_manufacturer" ) ] = "GIAT Industries",
...
SWEP.WorldModelOffset = {
    Pos = Vector(-5.5, 3, -6),
    Ang = Angle(0, 0, 180),
    TPIKPos = Vector(-8.5, 2, -5),
    TPIKAng = Angle(-12, -0, 180),
    Scale = 1,

    TPIKPosSightOffset = Vector(1, 2, -2.5),
}
