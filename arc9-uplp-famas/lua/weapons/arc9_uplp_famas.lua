...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/mp9/chback.ogg", t = 3 / 30, c = ca, v = 1 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUTREAL .. "magout.ogg", t = 8 / 30, c = ca, v = 1 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/mp9/chback.ogg", t = 39 / 30, c = ca, v = 1 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/mp9/chback.ogg", t = 90 / 30, c = ca, v = 1 },
