...
SWEP.PrintName = "RX45T"
SWEP.Description = "The RX Pistol is a series of modular multicaliber pistols. 
...
SWEP.ShootSoundSilenced = {
    pathUT .. "ar57/fire-sup-01.wav",
    pathUT .. "ar57/fire-sup-02.wav",
    pathUT .. "ar57/fire-sup-03.wav",
}
